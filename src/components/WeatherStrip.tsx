  ...
  return (
    <Animated.View style={[styles.container, { opacity, transform: [{ translateX }] }]}>
      ...
      <View style={styles.statsRow}>
        <Stat label="TEMP" value={`${weather.temp}°C`} sub={`feels ${weather.feelsLike}°C`} />
        <View style={styles.divider} />
        <Stat label="HUMIDITY" value={`${weather.humidity}%`} sub="relative" />
        <View style={styles.divider} />
        <Stat label="WIND" value={`${weather.windSpeed}`} sub="km/h" />
      </View>
      <View style={styles.rule} />
    </Animated.View>
  );
